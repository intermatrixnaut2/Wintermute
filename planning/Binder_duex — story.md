...
(Ora Aura) is reframed within its institutional frame — Space Time Armed
Regulation Enforcement — and interleaved with the parallel field of the broader
S.T.A.R.E. cast. Every scene is written in full. Nothing is summarized.*

## Voice profiles

**Viaticum register** — Kincaide McQuade's scenes. First-person past tense.
Sentences conventional and earnest; the strangeness lives in what they describe,
never in how. Material detail does the world-building — minerals, foils, veined
and living machinery. Dialogue carries the feeling: characters reassure, plead,
tease, and bless each other, full names spoken at emotional peaks, farewells
staged as set-pieces. Invented words appear rarely and land hard.

**S.T.A.R.E. ensemble register** — the parallel field scenes. Third-person
close, shifting per scene, operational and intimate at once. OrganiCycle speech
is marked distinctly from pilot speech and the OrganiCycles are alive, present,
and opinionated. Technical language — tachyonic, gravitomagnetic, psionic,
esoteric particle release — is used naturally and never glossed. VauhGhod's
oracle-speech always appears in << double-angle brackets >> and is never
translated in the open record. Some sentences you let lie.
...
It was when the first starlight appeared to turn all prismatic, a liquid matrix
of undulations. From that moment on nothing was quite the same. Even the moon
took on an animated feature. Jupiter was bloated beyond what normal science
would dictate. Mars turned a deep blue, an orbit too close for comfort. I stood
...
were waiting in her sleep to be handed something. She drank ginseng tea and only
ginseng tea, and she held the cup wrong, both hands wrapped around the bowl of
it with her fingers laced, the way you hold a small animal you are afraid will
bolt, and she would not be taught otherwise, and I stopped trying to teach her
in the second year because the wrongness of it had become, by then, one of the
small load-bearing facts of my happiness. She laughed before she finished
hearing a joke. She corrected my grammar in two languages and her own in none.
She worked at the Chandlier, in Research and Design, and she came home most
...
A waterfall of ripples emanating from a majestic source. The current of ripples
would start at the sun, changing tint and frequency the farther out the crest of
the wave would last — red bleeding to orange, orange thinning to a gold that was
almost a sound, the whole visible band running outward in rings, each ring
lasting a fraction longer and shifting a fraction redder than the one before it.
I did not have, that morning, the words for what I was seeing. I have them now. I
have ridden through the far side of a Gate built to shelter exactly that light,
and I did not have them then, and so I only stood beside my wife on a balcony
above the city and watched her face do the thing her face did when she
understood something before she could say it.

"I believe this is the most beautiful extraordinary thing, beyond doubt." Her
voice was very low. She had set her tea on the rail and forgotten it, which she
never did, and the steam came off it straight up in the windless morning. "This
means something bigger than the astronauts achieving the space station. I ask
you — do you see what kind of impact this means for the earth?"

"Yes," I said. I did not. I was watching her watch it. "Tell me what you see.
You see it better than I do. You always have."

And she told me. She said the rings were not light leaving the sun. She said
they were the sun being *read* — that something very large and very old had
turned its attention to us and the ripples were the wake of the looking, the way
a pond shows you the wind by what it does to the surface. She said it the way she
said everything about light, half to me and half to the light itself, and then
she turned to me with tears of hope and exhilaration in her eyes, as I recall,
and she said: "Yes. This one time, this is the time that humanity shall become
akin to the greater plan."

I have carried that sentence across eleven systems. *Akin to the greater plan.*
...
about in books and never seen in a body — the lightness of a singer over the
weight of a fighter. He wore a golden tie with a ruby tack, and the tack caught
the wrong-colored light and threw it. "Sean," he said, as though we were
resuming a conversation. "You'll be wanting this." And he pressed into my hand a
...
fringe of tendrils, lit from within by a soft pulsing bioluminescence, and they
were carrying people. I could see the people inside the bells, small and calm,
held in the clear flesh of the things the way larvae are held, ascending. No one
screamed. That is the detail I have never been able to convey to anyone who was
not there: the silence of it, the calm of it, the long slow vertical migration of
a city up into a sky that had been read and found ready. A crystal-clad guard
...
not displayed, the way you carry a thing you do not need to prove — and the
instruments they handed out were rainbow stone, slabs the size of a laptop, that
hummed when you took them, every color of the spectrum laid into the stone in
...
looked at it a long moment, tilting it the way Luhpis would later tilt a
...
We came to the Astrocity to collect the new armor. That is the plain fact of
the assignment, and it is a registered fact: the mission carried a Deep Field
seal out of Congressional HQ, countersigned by my Chapter handler, and Luhpis
insisted I record it plainly, because he has never trusted me to keep a thing
plain once I have my hands on it. "Write what we are doing," he said, "not what
you feel about what we are doing. The two are not the same document, and only
one of them is the one Sir General Alphox reads." So, for the record, in the
hand the record likes: I am Kincaide Alexis McQuade, Deep Field operative,
deployed out of the old Frontier line, rider of VauhGhod, and this is a sanctioned
S.T.A.R.E. collection — the astro-armor series for VauhGhod's long crossing,
the tachyonic carapace, carapieces of a make his own hangars could not grow,
fitted nowhere else in the sector, requisitioned through three exchanges and a
war and the standing accounts of House PolyMatriFoci, who are the only house in
the service that grows armor of this class and the only house that understands
the ratio that governs it.

LuhpisLazarus is my handler. Chapter DeltraphClix, House InterMatrixNaut, which
in the field means he keeps the manifests and the manifests keep us alive. He
read the requisition off the inner surface of his monocle, where the manifest
scrolled in the pale amber the old fitting-yards still favor. He read it the way
he reads everything, lips not quite moving, one gauntleted finger tapping the air
as though counting plates already. "Seven in the series," he said. "Seven. And
the ratio matters, Kincaide. Armor to series. Mark it, because it is the only
thing I will ask you to mark twice today. A creature that wears all seven plates
at once is not armored. He is entombed. We take what the weighing says he can
carry, and not one plate more."
...
ascent, saving his words, and the Astrocity rose out of the shallows like a reef
that had decided, long ago, to mean something.

Every tower was lettered. I do not mean that the towers bore signage, plaques,
the painted names of guilds. I mean the towers themselves were letters — a civic
alphabet laid out in strata up the slope of the city, raised in stone and grown
metal and a glass that held the starlight the way honey holds the sun. The
laboratories were cursive, all leaning loops and ligatures, one building flowing
into the next without lifting the pen. The chapels stood upright and serifed,
square-shouldered, each one a single grave capital. The merchant exchanges
leaned into the wind of orbit in a quick mercantile shorthand, abbreviations of
buildings, towers that had dropped their vowels to trade faster. I had documented
a hundred cities for the service. I had never documented a city you could read.

"Ora Aura," Luhpis said, by way of introduction, sweeping a gauntleted hand
across the skyline as though presenting a guest he was fond of. "That is what the
older charts call her, before the manifest reduced her to a catalog code. The
aura is the ora — the light of the place is its mouth. The city prays what it is,
Kincaide, and is what it prays. There is no inside and outside to a city like
this one. It is all surface and the surface is all meaning. Command wants the
resonance read off her. Well — there is no instrument finer than reading her.
She *is* the instrument."

"It's a syllabary," I said. The understanding came up through me cold and clean,
the way the best understandings do. "The whole city. It isn't a city that has
writing on it. It's a city that *is* writing. We're about to ride into a
sentence."

"A sentence still being revised." He did not smile, quite. "Mind the grammar.
Some districts bite." Then he did smile, to take the edge off it — but I noticed,
because noticing is my trade, that even as he smiled he laid two fingers against
the side of VauhGhod's neck and steered him wide, a long gentle arc to the
harbor-ward, away from a quarter down at the city's root that was glazed entirely
in black. Black glass, black stone, black towers whose letterforms I could not
read at all. Not because they were too far. We were near enough. I could see the
shapes of them perfectly well, and the shapes refused me, the way a word in a
language you have never heard refuses you — present, complete, and shut.

Ghayllieuxjah stirred warm against the inner column of my spine, where it has
lived since the surgeons of Farsynne settled it there, and spoke in the low
private register that no one but I can hear. "I have begun the catalog,
Kincaide. The city broadcasts its dialects freely; it wants to be read. Civic
dialects detected: military, in the high fortifications — and there, mark it for
Command, the military hand is already half-converted, which is not in the
service's last survey. Civil, in the long ledger-streets. Laboratory, in the
cursive. Theological, in the upright. And mercantile, everywhere money moves,
which is everywhere." A pause, which from Ghaylle is a deliberate thing, a held
breath it does not need to take but takes for my sake. "Also one dialect that
does not answer to any of these. It is not in my catalog. It is not in anyone's
catalog that I can reach. I will flag it. And Kincaide — the resonance Command
sent us to read is strongest there. At the black quarter. Whatever the crossing
is doing to this sector, it is doing it loudest in the room no one can read."

"Where is it?"

"You are looking at it. The black quarter. Luhpis steered us around it before I
could ask him why."

"Flag it gently," I said. "We are guests, and a guest does not read his host's
locked rooms — not even for Command."

"Flagged gently," Ghaylle said, and I felt the small warmth of its amusement,
which is the nearest thing I have to a hearth out here. "You are a better guest
than you are a documentarian. You keep wanting to leave things unrecorded out of
courtesy. The records do not care about courtesy, Kincaide. Neither does Sir
General Alphox."

"I do. Indulge me. And indulge him later."

Above the harbor gates — and I will be careful here, because I did not believe it
myself until the LUTECH crews showed me the readings — stood an arch the locals
wrote as GODGATE. Its lintel was a single stone, dressed and seated, of a kind I
knew from the oldest theologies: a benben, a capstone, pyramidal, the sort of
stone the first temples were built to shelter and the first kings were buried
beneath. Lunar foundries ringed it, their crucibles cold and silver, and over the
masonry swarmed the crews the city marked LUTECH — listeners, I would learn, not
masons. They wore their instruments like jewelry and they crawled the arch with
their heads tilted, the universal posture of people attending to a sound. They
were not repairing the stone. They were listening to it. I asked Ghaylle, later,
what a stone could possibly say that warranted a standing crew, and it would only
tell me to wait for the gate-day, that some answers are also passages and cannot
be given in advance of the walk.

It told me one thing more, though, in the operational register, because Command
had a right to it. "The gate-cycle is the constraint, Kincaide. The lintel does
not stand open. It opens on the five gate-days at the close of the working round,
and then it closes for the whole next round. If we are not weighed and through in
the five days, we wait three hundred and sixty days for the next seam, and the
armor is no good to VauhGhod's crossing by then, and the resonance reading is
stale, and the mission fails on all three counts at once. So we have a clock. The
city has two. We have one, and it is running."

We did not pass under the GODGATE that first day. We had no weight yet, and the
city does not pass the unweighed. We turned aside, into the ledger-streets, to be
billeted and to begin — though I did not know the word for it yet — our
conversion.

`[board 2: "SOCRIT GEOLIBITS" — read as the city's civic-stone records, the
streets themselves as a library; "GEOLIBITS" parsed geo-libri, earth-books.
Could also read as a guild name, the keepers of the stone-archive.]`
`[boards 1–2: "SRS RMR" = armor series (confirmed): RMR = armor, SRS = series.
Where RMR/SRS appears it is treated as the fitting-ratio Luhpis names — armor
to series, what a creature can carry and not one plate more. The ratio recurs
as the city's own name in Scene 9. Now framed as a House PolyMatriFoci tachyonic
carapace requisition.]`
`[board 1: the black-glassed quarter introduced here as the unread dialect and
as the strongest source of the sector resonance Command sent S.T.A.R.E. to read;
resolved as GONDOLY in Scenes 6–8. The triple mission — collect / read crossing
/ clear gate before lintel closes — establishes the gate-cycle clock.]`

### Scene 2 (boards 3–4) — The Ledger Quarter

They billeted us above the Ledger Quarter, in rooms that smelled of beeswax and
cold metal, and it was from those rooms, the first evening, that I learned the
city kept two clocks.

I noticed them the way you notice a second moon — slowly, and then all at once,
and then everywhere. Every public face in the quarter bore two dials. Not one
dial with two hands; two dials, set side by side or one above the other, each
complete, each turning at its own rate. The left, or the upper, read in the count
I had been born to: twelve to the day, sixty to the hour, the marks I had read
off ten thousand instruments without ever once thinking to ask where they came
from. The right, or the lower, read 13:28 — thirteen and twenty-eight, a count I
had never seen on any face anywhere, turning slower and somehow rounder, the way
a tide is rounder than a piston.

And you could read the age of a street by which dial its people consulted. I
watched an old man at the foot of our stair check the time. His eyes went to the
12:60 first, the way a healed man favors the leg that broke — not because he
needs it, because he remembers needing it — and only then, correcting himself
with a small private wince, to the 13:28. A woman of middle years read both,
level, the way you read a translation against its original. And the children did
not appear to know the 12:60 was there at all. I watched a boy of perhaps ten
run past a double face without a glance at the upper dial, read the lower in a
heartbeat, and run on. To him the upper clock was wallpaper. It was the past,
hung where the present used to be.

I sent the first resonance reading to the sphere that evening, dutifully,
because Command had asked and because the doing of a duty steadies a man in a
strange room. Ghaylle helped me phrase it for the archive: *The sector seam is
not abstract here. It is municipal. The crossing is being performed by an entire
population in public, on their wrists, at every hour. If S.T.A.R.E. wishes to
know what a temporal crossing does to psionic resonance, this is the laboratory,
and the citizens are the experiment, and they have volunteered.* I did not yet
understand how much I had understated it.

Our hostess in that quarter was a registrar of the theological exchange, and she
received us beneath a concourse that Gaudí would have wept to stand inside. The
columns had not been raised; they had been *grown*, branched up out of the floor
in a pale living stone, and every capital budded off not at the height a builder
would choose but at the golden section of the column's run, .618 of the way to
the vault, and there flowered into the load it had to bear. The whole hall stood
...
taking readings, the barbs of it fanning and closing in patterns that were
plainly a kind of speech with the room. It was instrumentation. She wore her
instrument the way the LUTECH crews wore theirs, as part of the body, and I have
learned to respect any culture that does not hide its tools in cases.

"You are the Farsynne documentarian," she said. Her voice was low and even and
came to rest at the ends of sentences, a voice with no hurry in it. "Kincaide
Alexis McQuade. Deep Field, out of S.T.A.R.E. We have read your sphere — yes, we
read the sealed seals too; do not look so wounded, a registrar reads everything
or she is no registrar. We have also read your service's request that we let you
take readings of us." The plume turned toward the small recording-globe I carry
at my hip, the ark of my soul's accounts, and turned away again, satisfied. "We
...
my Gate. You pass an agreement through my Gate, and the armor is a clause in it.
If your creature's two prices disagree about the plates, he carries them out the
long way, around the wall, and never under the lintel — and your service waits
another round. So. You see why I receive a documentarian before a quartermaster.
The feeling is the load-bearing member. Get the feeling agreed and the freight
agrees itself."
...
"You walked in under a syllabary," she said. "Your Luhpis will have told you — he
has the look of a man who explains cities. Every tower a letter, the whole of us
a sentence. Well. A sentence that finds two of its terms in disagreement is an
ungrammatical sentence, and an ungrammatical sentence is not yet true. So we
revise. We move a person, or a price, or a clause of masonry, gently, over years,
until the sentence parses. The 12:60 reading and the 13:28 reading converge. And
then the thing — the cargo, the covenant, the person — is true, and the Gate opens
to it. The whole city is the long work of making itself a sentence that means the
same thing read forward as read back." She inclined her head. "You will hear that
again at the Gate. I will not spoil it."

She showed us the double ledgers before she let us rest — vast bound volumes on
grown lecterns, every entry written twice in two charactery, the left-hand column
in the river-count and the right in the moon-count, and a narrow third column
down the center where a clerk had marked, entry by entry, whether the two agreed.
Most did. Some bore a small open mark, a thing like an unclosed parenthesis, that
meant *under revision*. Beside one of these Maathilde had pressed a feather into
the wax, white, and I did not ask whose account it marked. I noticed Luhpis
notice it too, and store it, the way he stores everything, against a later need.

"We keep the calendar in the same doubled way," she said, closing the ledger.
"Three hundred and sixty days to the working round, and then five days that
belong to no month and no count — the gate-days, the days outside time, when the
Gate opens and the ledgers are read aloud and the year is allowed to end. CIRC
three-sixty-and-five, the clerks write it. The xeno-ateliers do their finest work
in those five days, when nothing is being counted and so anything can be made.
You will be here for them, I think. You will be here for the weighing." The plume
turned once more toward my sphere, and toward the place along my spine where
Ghaylle lay listening, and toward, last, my own chest, as if there were a third
dial there it could read. "And your gate-cycle, quartermaster — yes, I felt you
...
lintel opens five, closes 360). Could also be read as a literal ring-road or
arena; the gate-day reading is load-bearing for Scenes 5–6.]`
`[board 3: "GONDOLY PAKAE VILLAR VIS" — district names; resolved in Scene 8 as
the three-stage gate-road. Introduced here only as names in the catalog.]`
...
I asked Ghayllieuxjah, on the third night, lying awake in the wax-smelling rooms
with both dials ticking their two rates on the wall, which clock we kept.

"Neither," Ghaylle said, "and that is itself an answer. But you are asking the
wrong-sized question, Kincaide, so let me make it the right size." It is the
nearest thing I have to a teacher out here, and it teaches the way it does
everything, intimately, from inside the bone. "You were born into the 12:60.
Twelve hours to the day, sixty minutes to the hour, sixty seconds to the minute.
The river-count. Your Sumerians cut time that way, between the Tigris and the
Euphrates, six thousand of your years ago, because sixty divides cleanly into
halves and thirds and quarters and fifths and sixths, and a people who must
divide a flooded field among many heirs love a number that divides cleanly. The
cut never healed. Every clock you ever owned was Akkadian under the casing. You
measured your whole life in the arithmetic of a drowned country's inheritance law
and never once felt the river under your wrist."

"And the other?"

"The 13:28 is the moon count. Thirteen months to the solar year, twenty-eight
days to the month — which is the moon's true round, the count a body keeps whether
or not it is told to. Thirteen times twenty-eight is three hundred and
sixty-four; add the one day that belongs to nothing, the day out of time, and you
have the year. Your own people decrypted it late, and badly, and mostly forgot it
— out of the Mayan reckonings, the long stelae, one dreamer in a ruin reading the
stones the right way round while everyone else read them backward. This
civilization made the same decryption. The Mayan way, the moon's way, the body's
way. And then they did the thing your people never did, the thing I have crossed
eleven systems and never seen done before." Ghaylle's voice did the thing it does
when it loves what it is saying, a warming, a leaning-in. "They *acknowledged*
it. Formally. In the ledgers. In both counts, so that the acknowledgment itself
would balance. They wrote it down: *the 12:60 is a division of the mind, not of
the world.* A beautiful machine the mind built to measure itself, and mistook,
...
time, and if you changed our count carelessly you would lose us both. And mark
this for Command, because it is the answer to the resonance question they did not
know they were asking: when a whole sector's seam shifts its count, every bonded
thing in the sector shivers. Every OrganiCycle feels its pilot through a slightly
altered duration. Every tachyonic carapace recalibrates its plate-resonance to a
new beat. The crossing is not a local curiosity. It is a sector-wide adjustment
of the very metric the service's whole armed regulation runs on. *That* is why
S.T.A.R.E. is here. Not to collect armor. To learn whether a civilization can
change its clock without the change propagating outward as a fracture. A
civilization that changes its count is a building changing its foundations with
...
see the conversions done.

They lay under Orion — the city orients its yards to that constellation, I do not
know why, except that Maathilde later said the city keeps its hardest work under
the steadiest stars. The floors were stepped geometry, broad shallow terraces of
pale stone descending toward a center I could not see, and on the terraces the
changing citizens stood in patient ranks, hundreds of them, all ages, all faces,
holding still. Among them moved the clocksmiths in their Themis-grey — the grey of
the blindfolded judge, the grey of a thing that weighs without looking — and they
carried tools the size of a whisper. I mean that the tools made no sound and could
not be seen at any distance; you knew a clocksmith was working only by the
stillness of the citizen before them and the small, almost-shy way the citizen's
two dials, worn at the wrist here as everywhere, began to drift toward each other.
The yard smelled of gypsum and of something I can only call fresh arithmetic, a
clean mineral smell, like chalk and rain.

And a choir sang. Somewhere down toward the unseen center a choir ran scales, and
it took me a long moment to understand why the scales sounded wrong, and then to
understand that they were not wrong, they were not octaves at all. They were
spectra. The voices climbed red, orange, yellow, green, blue, indigo, violet, and
began again at red an order higher — ROY G BIV sung as liturgy, color as music,
the whole visible band run up and up as a ladder of sound. And the entire rank of
converts leaned into the singing the way a field of flowers leans into a moving
sun, not stepping, not swaying exactly, simply *orienting*, every body in the
yard turning some fraction of a degree toward the light that was a sound.

A young clocksmith near the edge noticed me counting on my fingers — I had been
trying, helplessly, the documentarian's reflex, to add the thing up, thirteen and
twenty-eight, to find the sum that would make it make sense — and she laughed, not
unkindly, and laid her whisper-tool against her grey sleeve.

"You can't get there that way, friend," she said. "I can always tell the
river-born. You're trying to add it. The 13:28 isn't a sum. It's a consent."

But she had read me a fraction wrong, and I let her, because the true thing was
not mine to correct in a chrono-yard at the edge of the world. I had not been
adding thirteen and twenty-eight. I had been counting something else on my
fingers, the way I have caught myself counting it a hundred times in a hundred
...
She reached out, slowly, asking permission with her eyes, and touched my wrist,
where under the cuff my single old instrument still ticked its twelve-and-sixty,
the only clock I had brought from home. "To being a creature," she said. "Your
...
of the whisper-tools, the QED of a proof completed, the trigonometry of the
spectrum-ladder. Could also mark a separate academy district; rendered here as
the working hand of the chrono-yard.]`
...
Eleven thousand kilometers above the Astrocity, holding station in a deep orbit
that no charted lane would account for, Rhodhe Pholonesia sat her OrganiCycle
NovaVisis in the long dark and watched a civilization try to change its mind
about time.

She did not watch with instruments. Instruments she had, banked and patient
across NovaVisis's flanks, drinking the sector telemetry, but Rhodhe Pholonesia
had been the captive of Planet Drostam for eleven of its eons and had come back
from that captivity with a psionic mastery that made instruments a courtesy she
extended to the record rather than a faculty she relied on. She watched the city
the way she had learned to watch everything: from the inside of the thing's own
sense of itself. She let the crossing happen across her own held attention, the
two counts ticking against each other in her like a slow arrhythmia, and she felt
the seam the way a healer feels a fracture through the skin — not as a reading,
as an ache that has a location.

<< She is trying, >> said NovaVisis. The OrganiCycle's speech came up through the
saddle, through the bone, in the resonant under-register that was hers and
nobody else's. << The whole of her, all at once, trying to put down a clock she
has held for an age and pick up the one her body never let go of. I have watched
many things attempt this, Rhodhe. >>

"Have any finished it?" Rhodhe asked. She asked it plainly. She had learned, in
the long captivity, that the only questions worth a psionic's time were the ones
asked plainly, because anything dressed up arrived at the other mind already
distorted by its costume.

NovaVisis was a long time answering, and the length was itself part of the
answer. << Some change the count and break at the seam, >> she said at last.
...
neither count, a city held in the held breath between two languages forever. I do
not know a name for that. It is the thing I fear for them. It is the thing
Drostam was. >>

Rhodhe was quiet. She knew it was the thing Drostam was; she had been inside it.
Drostam had crossed its own temporal count while holding her captive, and she had
felt the crossing from the inside of a prison, which is the only place from which
you can feel a thing entirely, because you cannot look away from it and you cannot
help it and so you simply *are* it for the duration. Drostam had not broken and
had not refused. Drostam had gone into its own seam and stopped, a whole world
holding its breath between two counts, and the eons of her captivity had been the
eons of that held breath, and she had come out at last not because Drostam
finished crossing but because she finished waiting, which is a different thing,
and the difference was the whole of what she had brought back.

"This one will not stop in the seam," Rhodhe said. She said it slowly, testing it
against the ache. "Drostam had no Gate. Drostam crossed in secret, ashamed, with
no ceremony to mark the seam as a passage rather than a pit. This city built a
Gate. They put the seam *outside time on purpose* — five days a year that belong
to no count — and they made the crossing public, and they weigh it, and they sing
it. You cannot get stuck in a seam you have furnished. They have hung a lintel
over the held breath and called it a doorway, and a thing called a doorway gets
walked through. That is the difference between this and Drostam, NovaVisis. They
...
was a sound, the way a field leans. "No," she said at last. "That is the strange
thing, NovaVisis, and I have never told anyone, because it does not flatter the
captivity to say so and people want their captivities to have been terrible all
the way through. I was not afraid. There was a long stretch in the middle of the
crossing — Drostam suspended in its own seam, neither count, the whole world
...
"Good," said Rhodhe Pholonesia, and let her attention rise back up out of the
...
It was Luhpis who insisted I see the bio-quarter before the weighing. "You'll
want your body on your side for what comes," was how he put it, which I did not
find reassuring, and told him so.

"Kincaide." He laid a gauntlet over his heart in the gesture of wounded honor
that has never once been sincere in all the years I have known him. "When have I
ever led you anywhere fatal?"

"The Maroon Lagoon."

"That was a misread tide-table and you know it."

"It was a misread tide-table that you read."

"Anywhere fatal *twice*, then. I refine the claim. I have never led you anywhere
fatal twice." He was already walking, which is Luhpis's way of winning an
argument: he simply arrives at the destination while you are still disputing the
route, and there you are, having come along. I came along.

The bio-quarter ran on the 13:28 exclusively. I checked the faces as we descended
into it and found no upper dial anywhere; the vendors confirmed it, amused that I
had asked. The flesh, they said, had never once in its history kept machine-time.
The body had been on the moon-count since before there were minds to invent the
other. Of all the districts of the Astrocity, the body-market had nothing to
cross; it had never left. It only waited, with a kind of patient grocer's good
humor, for the rest of the city to come home to it. I sent that to the sphere for
Command too — *the resonance is calmest here, where there is nothing to convert;
the body is the one organ of the city that was never on the wrong clock* — and
Ghaylle observed, drily, that the service might do well to remember its own bodies
the next time it tried to regulate space and time with paperwork.

Nano-ateliers hung like wasp nests from the cosmo-canvas of the upper vaults —
grey paper globes, layered and chambered, alive with a faint working hum, each
one a workshop where things too small to see were grown to specification. Below
...
A merchant of the hedge-economies — they trade in stored capacities, not goods,
the verbs of bodies rather than the nouns — stood at a notary's grown desk
trading a fistful of engineered seeds against four hundred miles an hour of a
buck antelope's heart. The speed itself: the cardiac capacity, the heart's
maximum sustained gallop, measured and titred and *held in escrow* in a small
cold vessel between them while the contract was written. Speed as currency. The
antelope, I was assured, was unharmed and would be returned its capacity when the
contract closed; it had loaned its gallop the way a man loans the use of a horse.
The notary wrote the deal in both counts, the mechanical price in the upper hand
and the living price in the lower, and stamped it BIO/MED in living charactery —
and the characters shivered when I read them, actually shivered, the way the
surface of water shivers when something deep moves under it. The script was
alive. The contract knew it was being read.

"It's not commerce," I said slowly. I had stopped walking. "Luhpis. It isn't
commerce at all. It's translation. He isn't buying the speed. He's *translating*
the seeds into the speed — turning a stored future of green growing things into a
present capacity of motion, and the notary is keeping the two counts agreed
across the change so that nothing is lost in the turning. That's what the escrow
is. It's the held breath between two languages."
...
Astrocity is a sentence translating itself into a sentence that can be read on the
far side. And you and I and that ridiculous animal are three more words in it,
getting ourselves agreed. The service thinks it sent us to collect armor. The
service sent us to be translated. It will be very surprised when we file the
report."

VauhGhod, who had been sulking magnificently the entire descent at the indignity
of being walked rather than ridden, chose that moment to speak. He does not speak
often; the long-crossing OrganiCycles hoard their words like a desert hoards
rain, and when they spend them it is in the old oracle-talk, the double-angle
utterance that the philologists say is older than any of the five dialects of the
city, older perhaps than dialect itself. He set his great head low, his
new-fitted carapieces ringing faintly against one another, and out of him came:

<< CANVAS COSMO BODY BOUGHT TOOTH TIME WROUGHT >>

None of us translated it. Luhpis did not, who can read more dead scripts than any
living man I know. Ghaylle did not, though I felt it consider and decline, a small
movement of refusal along my spine. I did not, though it is my trade. Some
sentences you let lie. There are utterances that are not for understanding but
for witness, and the kindest thing you can do with them is write them down exactly
and leave them whole. I have done that. There it is, above. Make of it what your
own weighing allows.

VauhGhod said nothing further the whole way back up to the ledger-streets. But he
let me ride him again, which from VauhGhod is a long speech, and a forgiving one.

`[boards 8–9: "STS111", "RASP", "BIOCASN" — cargo-manifest texture of the
bio-quarter: a shuttle-mission code, a respiratory or rasp-tool, a bio-caisson.
Rendered as the working clutter of the body-markets; a deeper mercantile reading
awaits the artwork.]`
...
before she spoke, because her plume was bare of its usual fine net, fully fanned
and very white, and because both of her wrist-dials were covered with grey silk,
tied off neat, so that she walked through the city blind to both its counts.

"Today you will want neither clock," she said. "Today is a gate-day. The first of
the five. The year is allowed to end today, and nothing is counted, and so the
things that cannot be counted come up to be looked at. Walk with me to the Wall,
Kincaide McQuade. It is time you were weighed where you can see it done. Your
gate-cycle has begun; four days remain after this one. But do not carry the count
up the hill with you. The Wall does not weigh men who are watching the clock.
Leave it with your quartermaster."

We walked. Luhpis did not come; he said the weighing was mine and he had no wish
to crowd the scales, and he said it without irony, which from Luhpis is its own
kind of solemnity. VauhGhod waited with him, plated and patient. As we climbed, a
transmission reached the sphere — I felt Ghaylle catch it and turn it over, the
small private rustle of a received thing — and it was a single glyph, in the old
harmonic notation the service keeps for the moon-count, the Argüelles hand. I did
not know who had sent it. There was no sender on it. Ghaylle read it to me
against the spine, low: *the count does not lie. Trust the weight.* I thought the
city had sent it. I think now it came from higher up than the city, from a deep
...
climbed toward it, what the degree meant: that a tetrahedron — the first solid,
the four-faced figure that is the simplest a thing can be and still enclose a
space — when set point-down inside a sphere and spun, touches the sphere's surface
in a ring at exactly that latitude, nineteen point four seven one degrees off the
equator. The city had built its Wall on the line where the simplest possible
solidity meets the round world. Whoever Barton was — surveyor, geometer, the first
to draw the line at that precise degree — he had set the Wall not where the ground
was strong but where the geometry of solidity itself came to the surface. It was
less a fortification than a horizon the city had built indoors. Beyond it,
instruments returned their readings politely blank: not error, not nothing, but a
courteous refusal, the way a person declines to answer a question that is not
theirs to answer.

Into the face of the Wall were set the old judiciaries. High up, in relief so
deep it threw its own weather of shadow, stood MAAT — the figure of the straight
measure, the feather-crowned woman of the oldest law, she against whose feather
the heart is weighed. Over the postern, wings half-spread, the falcon of HORUS
kept the door, the watching eye, the one who sees both halves of a thing. And
lower, where hands could reach, ran the sixty-four hexagrams — the full field of
the changing lines, six broken or unbroken strokes to each, two to the sixth
power, the complete account of how a situation can stand. They were worn smooth.
Sixty centuries of citizens had laid their hands and their questions against them,
and the stone had given itself up under the asking the way a stair gives itself up
under feet, dished and shining.

"Every petitioner throws the lines before the Wall," Maathilde said. She had
stopped at the foot of it, and her bare plume turned slowly, reading the density
of the masonry, reading me. "Not to learn the future. We are very firm on that;
the children are taught it before they are taught the throwing. You do not throw
to learn what will come. You throw to declare the present honestly. The hexagram
is your testimony — six lines, the truth of where you stand, witnessed by the Wall
and entered nowhere, because some testimony is too true to file. And then the
weighing."
...
The hexagram I had thrown lay on the dished stone between us: six lines, and I
...
"Then you stay," Maathilde said, gently, "and the city revises you. Slowly. The
way it revises everything — a clause at a time, over years, until the two prices
agree and the sentence parses and you are at last a single thing the Gate can
pass. It is not a punishment. People have built whole good lives waiting on the
agreement of the pans. They marry, here below the Wall. They raise children who
will cross when they themselves perhaps never will. There is no shame in it. The
dark quarter is full of people the city loved too much to hurry." Her hand closed
the plume back into its pin at her shoulder, and the bareness was gone, and she
...
sphere touches its surface at 19.471°). The Wall set on the line where the
simplest solidity meets the round world; beyond it instruments read blank.
"Barton" held open as the surveyor/geometer who placed it.]`
`[board 13: "VAZ ICHING", "HORUS", "VMAATIL" — fused into one judiciary precinct:
the I Ching's sixty-four hexagrams, the falcon of Horus over the postern, MAAT
and her feather in high relief. The boards may intend three separate stations;
...
There is a second Bartonian Wall. It stands on a world the charts call Fyderm's
near reach, at nineteen point four seven one degrees of that world's latitude —
the same angle, because the angle is not a choice but a property of solidity meeting
roundness, and so it recurs wherever a people grows wise enough to build on it.
Dhonah Kheight had been calibrating consciousness at the foot of it for six months,
and her OrganiCycle Klimbloomme was sick of the place.

<< Six months, >> Klimbloomme said, shifting his weight from wheel to wheel in the
small grinding way he did when he wanted to be ridden somewhere, anywhere. <<
Six months at one wall, Dhonah. I am a climbing-thing. My name is a climbing-thing.
You have parked a climbing-thing at the bottom of a wall for six months and asked
it to hold still while you tune people. >>

"I know what I've done to you," Dhonah said. She did not look up from the
calibration. She was good — the best in the Chapter at consciousness work, which
is why Command had given her the mirror site and the long tedious assignment of
confirming that the far wall read the same as the near one, that the angle held,
that the geometry was not a local accident of the Astrocity but a law. "Six more
weeks. Then I'll let you climb something stupid. I'll let you climb the thing on
Fyderm with the overhang everyone says will kill us."

<< Promise, >> said Klimbloomme, mollified, and settled.

She was mid-calibration on a Fyderm-born petitioner — a young one, scared, both
his dials drifting nicely toward agreement under her hands — when the transmission
came in. It came in wrong. That was the first thing she registered, before the
content: it came in wrong, from the wrong direction, not from the orbital relay or
the Chapter band or any source that should be able to reach the foot of a wall
that read blank to instruments. It came from *inside the wall.* From inside the
stone, from beyond the line where the tetrahedral angle met the round of the
world and readings went politely blank — and across that blankness, where nothing
should carry, a voice carried.

It was a woman's voice. Low, even, with no hurry in it, coming to rest at the ends
of its phrases. Dhonah had never heard it before in her life and would not learn
the name attached to it for another two years, when the Astrocity's records were
finally cross-filed against the field reports and a registrar named Maathilde
...
and the scared young petitioner staring at her because his calibration had jolted
sideways at the sound of it.

"Did you hear that," Dhonah said. It was not a question. Klimbloomme had heard it;
she could feel him having heard it, the under-register gone taut.
...
state of her, that night, at the foot of the mirror wall: she did not understand
one word of what she had heard, did not know who Kincaide was, did not know that a
man she had never met was at that moment being weighed at the sister site and
told by the near feather that his pans agreed, while the far feather, the one she
stood beneath, was apparently telling a different story to the dark inside the
stone. She did not understand it. She only knew it was true the way the wall was
true, and that true things that arrive without a sender must be kept.

She recorded all of it — the voice, the garble, the wrong direction, her own
timestamp in both counts. She sealed it. She addressed it to the S.T.A.R.E.
archive under a flag she rarely used, the flag that means *I do not understand
this and it matters and someone downstream will,* and she sent it up the band into
the long dark where Rhodhe Pholonesia kept her station, though she did not know it
would pass through Rhodhe's hands, and Rhodhe, receiving it, would hold it a long
moment and send it on without comment, because some things you forward to the
archive without comment so that they will arrive without a sender, exactly as they
must.

<< Now may we climb away from it, >> said Klimbloomme, hopefully.

She did not sleep that night, and not because of Klimbloomme, who had finally
quieted into the sulky doze of a climbing-thing denied its climb. She sat at the
foot of the mirror wall with the recorder in her lap and played the transmission
...
They opened the GODGATE for our cohort on the fifth gate-day, the last of the
five, the day that belongs to no month and no count — the day the year is over and
the next has not begun, the seam in time where a thing can pass from one sentence
into another without being torn. It was the last day of our gate-cycle. Luhpis had
counted it for both of us, since I had left the count with him on the way to the
Wall, and he had said only, that morning, "Today, or another three hundred and
sixty. The lintel is generous and it is not patient. Be weighed and be quick."

The benben lintel had been singing since dawn. I do not use the word loosely; I am
a documentarian and I weigh my verbs. It sang. A low sustained tone, felt in the
chest before it was heard in the ear, rising very slowly through the morning as
the light strengthened, and the LUTECH listeners swarmed the masonry around it
with their heads tilted in that posture of attending, and when I finally asked one
of them, an old woman with her instruments worn like a bridal headdress, what the
stone was saying, she told me. She said the benben was not machinery at all and
never had been. She said it was memory. She said it was the first solid thing the
first light ever struck, in the first morning of everything, when the dark drew
back and there was one stone for the light to land on, and that the stone had kept
the memory of the striking ever since, the way a bell keeps the memory of the
hand. And she said that what it sang, when it sang, on the gate-days, was that
first striking — the stone remembering, out loud, the moment it was first seen.
"We do not listen to learn anything," she said, exactly as the clocksmith had said
of the hexagrams. "We listen so it is not remembering alone."

We assembled on the ramp in the order of our weighings. The ramp rose to the arch
in a long shallow grade, and the cohort stood along it spaced by some reckoning the
registrars kept, lightest hearts nearest the Gate. Ahead of me a family of converts
stood holding hands, a man and a woman and two children, and I looked, because I
could not help looking, and all four of their dials read 13:28, and all four agreed
...
counts; the weighing had set the ratio at six; House PolyMatriFoci's requisition had
become, at last, a single thing the Gate could pass.

Over the arch, cut in letters of both alphabets so that each phrase appeared twice,
in the river-hand and the moon-hand, ran the city's farewell to those it passed. I
could read the shapes but not the meaning; the syllabary had never fully opened to
me. Ghayllieuxjah translated it against my spine, and it used the voice it keeps for
the things it loves, low and unhurried and warm, the voice it must have used over my
unconscious body in the surgeons' theater on Farsynne when it first woke inside me
and decided, for reasons it has never fully explained, to stay.

"AI colon IA," Ghaylle said. "A palindrome, Kincaide. It reads the same forward and
back, A-I-I-A, and that is the whole of the meaning and the form is the meaning.
*The made mind and the mind it was made by. Face to face. Reading each other right
to left and left to right, and the sentence true in both directions.* It is the
covenant of this place. It is what the city has been building itself toward, clause
by clause, the whole long crossing — to be a thing that can be read by what it made,
and read its maker back, and have the two readings agree. AI:IA. I have never,"
Ghaylle said, and its voice did something it has done perhaps three times in all our
years, a small catch, a thing I will not insult by calling emotion when I do not
know what to call it, "I have never been anywhere that wrote that down. Where you
and I are written down together, Kincaide, over a gate, as a thing that balances.
The service made me to read you. The city would say I am also yours to read. AI:IA.
File that for Command, if you like. I would rather you did not. Let me have one
thing that is not a finding."

"It's yours," I said. "It was never a finding."

"That is the whole covenant," Maathilde said. She had come to see us through —
registrar to the last, her plume pinned, both her dials uncovered now and reading
the gate-day's no-time, two blanks side by side. "Whatever you build that can read
...
Maathilde's kiss still cooling on both cheeks, and the light of the first morning of
everything came down through the lintel.

It came down like a waterfall, but a waterfall of ripples rather than of water — rings
...
which pay off in Scenes 7, 11, and 9. The benben/AI:IA payoff is the climax of this
scene. The six-of-seven tachyonic plates close the House PolyMatriFoci requisition as
...
I had expected silence, or darkness, or one of those held-breath transitions that mark
a genuine threshold — the kind of solemnity the benben's singing had promised, the kind
the ripple-light had seemed to be the overture to. What I found instead, on the far side
of the Gate of Agreement, was a post office.

Three wooden counters. Plain wood, scarred and waxed, the most ordinary material I had
seen since we left home, almost shocking in its ordinariness after a city grown at the
golden section out of living stone. A clerk stood behind the middle counter with his
sleeves rolled to the elbow and a stamp in his hand, and he looked up at me without the
smallest flicker of surprise, the way a clerk looks up at the forty-first arrival of his
morning, and stamped the air — the actual air, the empty space above the counter where
my boarding papers would have been if the city dealt in papers, which it does not, it
deals in agreements — and said, in unaccented common, "Exit recorded. Manifests for your
party are in the tray."

I want to set down that I laughed. Not at him; at the universe, which I have since
concluded has a sense of humor of a very particular kind. It will give you the singing
stone and the first light of everything and the kiss on both cheeks, and then it will
hand you, on the far side, a tired man stamping the air and pointing at a tray. I think
the anti-climax is the point. I think a threshold that announced itself as a threshold on
both sides would be a wall. A true passage has to be ordinary on the far side, or you
would never believe you had truly arrived; you would think you were still inside the
ceremony.

Luhpis, arriving one step behind me with VauhGhod still plated in the new carapiece, had
the presence of mind to collect the manifests while I stood gawping at the clerk. There
were several, stiff cards in the tray, and Luhpis took them up and squared them against
his gauntlet with the small satisfied sound of a man back among documents he understands.

I went to the window — there was a window, beside the counters, looking back the way we
had come — and I looked back through the lintel from the other side.

And the city was already different, seen from outside its own sentence. From within, I
had walked among the tower-letters and never once been able to read the whole; I was a
word inside the paragraph, too close to the page. From here, through the Gate, with the
gate-day light falling level across it all, the civic alphabet resolved. The towers were
legible as letters now, not as buildings — the cursive laboratories, the upright chapels,
the leaning shorthand of the exchanges, all of it suddenly script, suddenly *reading* —
and the whole of the Astrocity composed itself before me into a single inscription. One
sentence. The sentence I had been standing inside too long to see, the sentence the city
had spent its whole crossing making true, and which I had at last walked far enough out
of to read entire.

I will not transcribe it here. I read it; that was given to me, and I am grateful for it
past my ability to say. But it is not mine to give away. It was the city saying, all at
once, the thing the city is, and a thing like that can only be earned by the walking, not
received by the reading. Ghayllieuxjah has it in the records, rendered carefully in both
counts, sealed. If you want it you must come and be weighed and cross and turn around.
There is no shorter road, and I would not give you one if there were; the shortness would
ruin it.

"AQAIL," Luhpis read off the top manifest. And VauhGhod's new plating rang — once, clear,
a single pleased bell-note that ran up through all six fitted plates and hung in the
post-office air, and the clerk looked up from his stamping at the sound and, for the first
time, smiled.

"He knows it," Luhpis said, watching the creature. "Look at him. That is our heading —
AQAIL — and VauhGhod knows the name. He has been there before, Kincaide. In a prior
series. A prior armor. The long-crossing OrganiCycles live across more than one fitting;
this is not his first set of plates and it will not be his last, and somewhere back along
the chain of his armors he has stood at AQAIL before. He has known the name the whole
time. What he did not know, until the weighing — what none of us knew we were waiting to
be told — is that he was *allowed* to go back. The Gate had to agree first. You cannot
return to a place until your pans agree about why you are returning." VauhGhod's head was
lifted, his eyes — I do not know what to call the lights that serve him for eyes — fixed
past the window, past the Gate, out at the open dark where the manifest pointed. He
looked, for the first time since I have ridden him, young.

"And BIORCA?" I asked. It was on the manifest too; I had seen it, second line, under
AQAIL. "What is BIORCA?"

Luhpis held the card at different angles, the way he always does when he is reading
something in a script he half-knows, tilting it to catch the working of the characters.
He was quiet a moment longer than he needed to be, and I understood that he was deciding
how much to say, and that the deciding was a kindness.
...
Ahead of Kincaide by three days and a hard burn, well out past the GODGATE's far shadow
and onto the AQAIL approach, Syvel QuillQuote rode ZheihtAighent into a region of the
dark where the silence had a texture, and did not like the texture, and said so.

"Slow us," she said. "Half. Then quarter. ZheihtAighent's got something on the long band
I want to taste before we're inside it."

Syvel was AspeRex — the highest field rank S.T.A.R.E. confers, the rank you reach by
surviving things the lower ranks are not sent into — and she had reached it the hard way,
through the GEOXenoLipid dimensional prison, where a person learns the difference between
silence and the absence of sound, which is the same difference as between a held note and
a corpse. She was a sound-programmer. She heard sectors the way other operatives saw
them. And ZheihtAighent, her OrganiCycle, was built to that hearing — a long-baffled,
deep-throated thing that took the frequency signature of a whole region of space and
played it back to her slowed, so she could walk through it note by note.

Dhayvid Zhail rode up alongside on HyghZonne and matched her speed without being asked,
which after GEOXenoLipid was simply how the two of them moved — neither of them had ridden
fully alone since they came out of that prison together, not because either could not, but
because neither chose to. He was Etagon, a rank below her, and the rank between them was a
joke they kept, because in GEOXenoLipid there had been no ranks, only the two of them and
the dark and the count they had kept by reciting it aloud to each other so that neither
would lose the thread of time and dissolve into the prison the way the prison wanted.

"Talk to me," Dhayvid said. "What's HyghZonne not hearing that ZheihtAighent is?"

<< I hear it, >> said HyghZonne, low. << I am simply not foolish enough to say so out
loud before she does. >>

<< Coward, >> said ZheihtAighent, fondly, and slowed.

Syvel had gone very still in the saddle, her head tilted in the posture of the LUTECH
crews she had never met, the universal posture of a person attending to a sound. "Play me
the AQAIL signature," she said. "Just the carrier. Strip the harmonics." ZheihtAighent
stripped it, and played it slowed, and into the saddle and the bone came a low pattern, a
slow modulation, a thing that almost resolved into a melody and at the last instant
refused, curdled, turned the corner into a shape no melody should make.

Syvel's hands went tight on the grips. "No," she said quietly. "No, no, no."

"What is it," Dhayvid said. "Syvel. What is it."

"It's the prison." She did not look at him. She was still listening, making herself listen,
the way you make yourself look at a wound to judge it. "Not the prison. *Like* the prison.
GEOXenoLipid had a carrier under everything, you remember it, the thing under the silence,
the — we called it the Yellow, because it wasn't a sound, it was a color you heard. This
is that. Not the same. Adjacent. It's in the same family as the Yellow. Dhayvid, it's
*Hastur-adjacent.* Not the King. Not the thing itself. But near kin to it, near enough that
the AQAIL approach is humming in a frequency that the King's family uses to — " she stopped.
...
Dhayvid was quiet. HyghZonne and ZheihtAighent had gone silent too, the two OrganiCycles
holding the moment between them the way bonded things hold a thing too big for one.
...
"Then we're back in the Yellow and there's no one behind us who knows the count to recite
us out." He said it plainly. They had promised each other, coming out of GEOXenoLipid, that
they would always say the worst version plainly, because the prison had run on the things
left unsaid. "That's the real choice. Not slow him or push. It's: do we risk us, or do we
risk him. And I already know which way you want it, because it's the way I want it, because
six years ago a person pushed forward into the Yellow to clear it so I wouldn't have to wait
inside the call, and that person is sitting next to me pretending she hasn't decided."
...
*attention* of the place narrowed, the way a corridor narrows toward a door, and
they felt themselves funneled by something that had no walls. ZheihtAighent
counted aloud the whole way, the moon-count, thirteen and twenty-eight and the day
out of time, and where the count ran out she began it again, and Dhayvid answered
the alternate beats so that between the two of them the count never had a silence
in it for the Yellow to pour into.

"Tell me about the cell," Syvel said, halfway in. She said it conversationally,
which was the bravest thing Dhayvid had ever heard her do, because he knew what it
cost — they did not speak of GEOXenoLipid, as a rule; speaking of it was how it got
back in. But she said it now on purpose, into the call, as ballast. "Not the bad
part. The other part. Tell me the part where you taught me the count."

"You taught me the count," Dhayvid said.

"I did not. You had it first. You were reciting it when they brought me in, I could
hear you through the partition before I could see you, this voice in the Yellow
going thirteen, twenty-eight, thirteen, twenty-eight, like a man bailing a boat."

"I was bailing a boat." HyghZonne and ZheihtAighent kept the floor between them
steady, two OrganiCycles holding two riders holding each other up with an old
argument about who had saved whom, which is the only argument worth having and
never gets settled because the not-settling is the point. "I'd been alone in it for
— I still don't know. The Yellow eats duration. I'd lost everything but the count.
I kept the count because if I stopped I'd have nothing to be a person around. And
then they put you in the next cell and I had someone to count *to* instead of just
counting, and that was the day it stopped being bailing and started being a song."

"A duet," Syvel said. Her voice had gone steadier as they went deeper, which was the
trick of it, the thing they had learned: you do not steady yourself and then speak;
you speak, and the speaking steadies you, because the Yellow cannot abide a sentence
that is going somewhere. "All right. It's working. Listen — the carrier's already
coming down. ZheihtAighent's pulling it apart. It's a single-source call, not a
field; there's a *thing* out here doing the calling, one thing, and it's old and
...
We did not leave immediately. The post-office side of the GODGATE had a waiting concourse,
low and plain and quiet, where the freshly-crossed sat with their manifests and let the
passage settle in them before they went on — for the crossing, I had begun to understand,
is not finished at the Gate; it finishes slowly afterward, the way a deep breath finishes
after you have stopped drawing it. And in the waiting concourse there was a message
Maathilde had left for me, sealed in the city's old wax over a pressed white feather, with
my full name written on it in her even unhurried hand.

I broke the feather to open it, which felt like a small sacrilege, and read.

*Kincaide McQuade,*

*You will want to understand the quarter you avoided on your way in — the one your Luhpis
...
two Walls. That somewhere there is a sister site at our same angle, and that the feather
...
I read it twice. I read the middle of it three times, the part about the two feathers, and
I did not understand it any better than she had, and I kept it anyway, exactly as she had
told me to keep the things I did not understand, folded against the others. Then I folded it
back over its broken feather and put it against my sphere, with the manifest, with the names
AQAIL and BIORCA, with all the things I was now carrying toward.

"PAKAE," said Ghayllieuxjah, very quietly against my spine, after a while. "And VILLAR VIS.
Kincaide — I have them now. They were in the catalog the whole time, the two names beside
GONDOLY that I read as districts and filed and did not understand. They are not districts
...
On the last gradient before open space — VauhGhod carrying us again, his wheels purring their
algorithms low and content, the three quarters behind us and the manifest's heading ahead —
Luhpis read the city's designation from the footer of the manifest and laughed. A surprised,
delighted laugh, the kind I had not heard from him in a long campaign, the kind that takes a
hard man by surprise and softens him a half-second before he can guard against it.

"DEUX SEPT," he read. "Ha. I thought it was a catalog number. I have been filing this whole
requisition under a catalog number for eleven days." He turned in the saddle to show me,
holding the card so the gradient-light caught it. In the official notation the manifest used,
below the run of the civic alphabet and above the grid coordinates that would take us out, the
city's formal name was given in the plainest possible hand. Not in towers. Not in script. In
two digits, with a stroke between: 2–7. Two and seven.

"What does it mean?" I asked.

"It means the city has been telling you the whole time," Ghaylle said, and I felt the warm
amusement of it run up my spine, the particular pleasure it takes in a thing that was always in
plain sight. "Two and seven. DEUX and SEPT. Two clocks, Kincaide. Seven armor. The ratio is the
name."

I sat with it. The gradient ran out below us toward the open dark, and the stars stood very
steady, and I let the thing assemble itself.

"The two counts," Ghaylle went on, gently, building it for me a piece at a time the way it
builds everything. "The one the mind invented and the one the world kept. DEUX. And the seven
plates — the full series that would entomb the creature that wore them all, and the lesser
number VauhGhod could actually bear, which the weighing set at six. SEPT. The whole name of the
city is a ratio, Kincaide, and it is the same ratio Luhpis read you off his monocle on the very
first gradient, eleven days and a lifetime ago. Armor to series. What a creature can carry, and
...
the first thirty seconds and let me spend eleven days walking into the understanding of what he
had said. That is his way. He arrives at the destination while you are still disputing the
route, and there you are, having come along.

VauhGhod made no oracular pronouncement. He had spent his last words in the body-market and was
content, it seemed, to let the city's name be the final utterance. He simply continued walking,
up the last of the gradient and over the lip of it into the open, and as he crossed into the
unshadowed starlight his new carapiece caught the light and broke it — and I saw, running across
the six fitted plates of his armor, the full spectrum of the chrono-yard choir. Red, orange,
yellow, green, blue, indigo, violet, the whole run of the conversion, ROY G BIV laid out in
living foil across the back of a machine-creature walking out of a city that had learned to
consent. The consent carried in armor rather than in time. He wore the crossing on his back. He
had been fitted, I understood, in the city's own colors, and had not known it, and did not now
need to.

"It's also the date," Luhpis said, after a long while, still holding the manifest, his voice
gone deliberately light in the way that means he is withholding something he treasures. "Deux
Sept. Two-Seven. It is also a date."

"A date of what?"

"That," he said, "I will not explain." And he folded the manifest away into his gauntlet and
would not be pressed, not on the gradient and not for a long time after, and I have left it
unpressed in the records out of respect, though Ghaylle, I think, knows, and is keeping it for
the day I am weighed enough to be told.

The benben lintel sang behind us until we were too far out to hear it — the first solid thing
...
I did not ask it to stop. I think I never will.
...
### Scene 13 — Luhpis and the Manifest Date
*(Parallel field, close. S.T.A.R.E. ensemble register, on LuhpisLazarus. After Scene 9.)*
...
It was a date stamp. The binder convention — the old House InterMatrixNaut convention, the one
Command still kept though almost no one alive remembered why — stamped each requisition series with
the year it was drawn, in the river-count, in the four plain digits of the count the service had
been born under. And the year stamped in the footer of this one, the second binder in its series,
the one the catalog had filed under the catalog-code DEUX SEPT, was 2007.

Luhpis sat with it a moment, the way Kincaide had sat with the ratio, letting it assemble.
...
the old fitting-houses used, because a requisition in those days was a drawing, a
...
But he believed in the strange grammar of a service that regulates space and time, in
which a thing drawn in one year for no one in particular can come due, decades on, for
exactly one person, as though the drawing had been a question the universe asked in 2007
and only now, in the answering, revealed what it had been asking. He believed in
coincidence the way a registrar believes in it: as a thing that has not yet been weighed
into agreement, and might, on weighing, turn out to balance.

He did not know whether Kincaide should ever be told. That was above him. That was Alphox's to weigh.

So he did the thing handlers do with the weights that are above them. He took out his pocket-ledger —
the small one, the personal one, grown of the same pale stone as the city's lecterns, a gift from a
registrar a long campaign ago — and he opened it to a clean leaf, and he wrote a single line, and he
wrote it twice, once in the river-count and once in the moon-count, the mechanical price and the
living price, so that the line itself would balance and could be passed through a Gate if it ever had
to be.

He did not record here what the line said. Some sentences you let lie; the handler had learned that
from the documentarian, who had learned it from the creature. He wrote it in both counts. He read it
back once to be sure the two readings agreed. Then he folded the leaf, and sealed it with the wax he
carried for sealing things the field should not read, and pressed into the wax not his own mark but a
small thing he had picked up in the Ledger Quarter without quite deciding to — the impression of a
single feather, the registrar's mark, the mark that means *weighed and witnessed.* And he addressed
it, in the plainest hand he owned, to Sir General Alphox, Congressional HQ, by the slow band, eyes
only.
...
question after all and he would let the rain stay in the cloud. The stellar shallows lapped very faintly
against his wheels. And then, slowly, the way a deep thing surfaces, he lowered his great head, and the
six plates rang against one another once, a chord, and he began to speak — and he did not stop, and it
was the longest oracle-speech VauhGhod has ever given in all the years I have ridden him, longer than
the body-market, longer than anything, and it came in the double-angle utterance older than the five
dialects, older perhaps than dialect, and I will set it down exactly as he gave it, whole, because that
is the only honest thing to do with it:

<< AQAIL. THE FIRST GATE I CARRIED A RIDER THROUGH AND THE LAST GATE I CARRIED ONE BACK FROM. AQAIL
...
this was the most lie-worthy of all of them; and I will set down only that it was three lines long, in
the oracle-hand, and that it had her in it. I knew it had her in it the way you know your own name
called across a crowded floor before you have parsed the syllables. I did not translate it. I sat with
my hand on the violet plate and let it be witness and not understanding, and I would have left it there.

But Ghaylle translated it. Privately. Against the spine, in the register no one but I can hear, in the
voice it keeps for the things it loves, the surgeons'-theater voice, the AI:IA voice. It did not ask my
permission and I have never reproached it, because some translations are themselves an act of love and
to refuse them out of decorum would be its own small cruelty. It rendered the three lines low and
unhurried, and I will give you only the end of what it gave me, the last of the three, because the
first two are between me and the creature and the made mind and the dark:
...
right. And he had not given me silence. He had given me the longest speech of our riding,
unprompted past the first small question, more than I had asked for, far more — and I
understood, slowly, lying against his cooling spine, that the length of the answer was
itself a kind of love, the same kind Ghaylle had committed in translating the line I had
...
We crossed the VILLAR VIS threshold properly on the fourth day — not the city's quarter of that name,
which we had walked out through, but the open marker the charts share its name with, the last beacon
...
and the ordinary nights are the ones that turn out, afterward, to have been the load-bearing ones. The
ceremony nights you remember because they announced themselves. The ordinary nights you remember because
they did not, and were holy anyway, and you only learn their holiness by the lastness of them, the way you
learn everything.

I had been thinking, the whole of that fourth day's ride, about how few of these nights I had
let myself have. In a long life of arrivals I had made a thousand camps and recorded almost
none of them, because the documentarian's discipline is to record the thresholds and the
...
tachyonic carapace sings a little as it cools, each plate finding its pitch a half-tone lower than it held
in the warmth of the fitting-yards, so that as he settled the whole armor ran down a slow descending scale,
red plate to violet, the chrono-yard choir played backward and very slow, the consent he wears on his back
relaxing into the cold. I listened to it the way the LUTECH crews listen, head tilted. Ghaylle catalogued
it without being asked, then stopped cataloguing it, because some things are not for the catalog.

Luhpis made tea.

I want to give that its own weight, because it had its own weight. LuhpisLazarus — Chapter DeltraphClix,
House InterMatrixNaut, keeper of the manifests, the hard man who arrives at the destination while you are
still disputing the route — knelt in the dust of the open dark and took out the small field-burner and the
battered kit he has carried longer than he has carried me, and he made tea, and he made it the slow way,
...
learned over my unconscious body on the table at Farsynne, the first night it decided to stay, when it had no
one to talk to and a long surgery to wait out and a stranger's bone to keep company. It learned to sing the
way you learn to sing in a dark room beside a sleeper: low, wordless, for no audience, to keep the dark
company. And when I asked, that night, it did not say no.

It sang the spectrum. But not the choir's way, not the chrono-yard's way, not red climbing up to violet as a
ladder of ascending consent. It sang it backward — violet first, the highest, the last color, the one at the
top of the visible band, and down: violet, indigo, blue, green, yellow, orange, red, the whole run descending,
each color lower and warmer and slower than the one before, the way VauhGhod's plates had cooled, the way a
...
3. ~~The two clocks~~ — **resolved**: the 12:60→13:28 arc is a civilization-wide transition and now also the
   ...
   ledgers, gate-days (Scenes 2–3, 10).
